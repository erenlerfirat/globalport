        ...
        <section className="bg-white dark:bg-gray-800 my-4">
            <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                ...
                <form action="#" className="space-y-8">
                    ...
                    <Button style="py-3 px-5 text-sm font-medium text-center text-gray-600 dark:bg-white bg-gray-200 rounded-lg sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:hover:bg-primary-700 dark:focus:ring-primary-800">{"contact"}</Button>
                </form>
            </div>
        </section>
    )
